...
export const EventSlice = createSlice({
  ...
  reducers: {
    ...
    setReloadDashboardEvents: (state, action) => {
      state.reloadDashboardEvents = action.payload.reloadDashboardEvents
    }
  },
})
